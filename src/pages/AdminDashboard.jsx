  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-1">
                Manage your solar leads effectively.
              </p>
            </div>
          </div>
          <button
        ...
        {/* Two-column layout: left sidebar (stats + filters) and right main (leads table) */}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
          {/* Sidebar */}
          <aside
            className={`fixed left-0 top-0 h-full w-64 bg-slate-50 z-40 transform transition-transform duration-300 lg:relative lg:col-span-1 lg:transform-none ${
              sidebarOpen
                ? "translate-x-0"
            ...
            <div className="sticky top-6 space-y-6">
              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="mt-3">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 appearance-none cursor-pointer"
                      >
                  ...
                  <div className="mt-4 flex gap-2">
                    <button
                      onClick={exportToCSV}
                      className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-emerald-50 text-emerald-600 rounded-xl hover:bg-emerald-100 transition-colors font-semibold"
                    >
                      <Download size={16} />
                      Export
                    </button>
                    <button
                      ...
                      className="inline-flex items-center justify-center px-3 py-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors"
                    >
                      Reset
                    </button>
                  </div>
              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="mt-3 text-sm text-slate-600">
                  {/* You could inject service stats here if backend returns them */}
                  {/** Placeholder content for service stats */}
                  <p className="py-1">
                    Off Grid Solar System —{" "}
                    {
                      inquiries.filter(
                        (i) => i.service === "Off Grid Solar System"
                      ).length
                    }
                  </p>
                  <p className="py-1">
                    ...
                    {
                      inquiries.filter(
                        (i) => i.service === "Solar Water Pump System"
                      ).length
                    }
                  </p>
                  <p className="py-1">
            ...
            {filteredInquiries.length > 0 && (
              <div className="mt-6 flex items-center justify-between">
                <p className="text-sm text-slate-600">
                  ...
                  of {filteredInquiries.length} leads
                </p>
